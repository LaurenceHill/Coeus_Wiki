...
- **1978** — restates the four-criteria framework with sharper
  ...
  (_"as long as excess productive capacity exists, prices tend to
  reflect direct operating costs rather than capital employed"_); and
...
- **1979** — return on equity over EPS is asserted directly as
  _"the primary test of managerial economic performance"_; the
  _"turnarounds seldom turn"_ slogan first appears (Waumbec Mills);
...
- **1980** — the most analytically dense letter of the early period.
  ...
  (_"the value to Berkshire Hathaway of retained earnings is not
  determined by whether we own 100%, 50%, 20% or 1% of the businesses
  in which they reside"_; _"if a tree grows in a forest partially
  owned by us, but we don't record the growth in our financial
  statements, we still own part of the tree"_). Endorses share
  ...
  most-quoted Buffett line on industry economics: _"when a management
  ...
  the business that remains intact."_ Distinguishes franchise rescue
...
- **1981** — formalises Buffett's acquisition philosophy. Contains
  ...
  explicitly disclaims Category 2 membership. Introduces the _Noah
  principle_ (_"predicting rain doesn't count, building arks does"_).
  Quantifies the hurdle-rate problem: with passive after-tax returns
  elevated by inflation, most American businesses produce _no
  value-added_ for individual investors — even at flat or modestly
  growing earnings. Introduces the _"inflation tapeworm"_ metaphor
...
- **1982** — formalises acquisition discipline into a published
  ...
  share-transaction discipline: _"the issuer of stock receives, in
  essence, the same consideration as the buyer of stock receives"_
...
- **1983** — the most foundational letter in the early corpus.
  Contains the _Owner's Manual_ — Buffett's thirteen business
  ...
  _Goodwill and its Amortization_ appendix, the canonical
  ...
  inflation insight — _"Goodwill, in inflation, is the gift that
  keeps on giving"_ — links economic Goodwill to the inflation
...
- **1984** — applies the 1983 frameworks to a year of cash-rich
  ...
  Washington Post buyback case study introduces the _triple dip_:
  ...
  _harem of forty women_ compressed image of diversification's
...
- **1985** — closes the early period with the textile shutdown
  ...
  _"a good managerial record (measured by economic returns) is far
  ...
  appears as the ad-driven acquisition: _"we have no master
  strategy ... we simply hope something sensible comes along —
  and, when it does, we act."_ Updates:
...
- **1987** — the [[Mr. Market]] parable is stated in full, sourced directly
  from Graham's _Intelligent Investor_. Buffett introduces the
...
- **1990** — look-through earnings named explicitly for the first time,
  ...
  analogy extends the [[Mr. Market]] framework: _"It's optimism that is
  the enemy of the rational buyer."_ Junk bond critique: the dagger-on-
...
- **1992** — the [[Growth vs Value False Dichotomy]] named explicitly:
  _"the two approaches are joined at the hip: Growth is always a
  component in the calculation of value."_ John Burr Williams DCF
...
- **1993** — the most sustained critique of beta as a risk measure in the
  ...
  _"conventional diversification makes no sense for you. It is apt
  simply to hurt your results and increase your risk."_ The
...
- **1994** — formal definition of intrinsic value: _"the discounted value
  ...
  _"Dealmaking beats working. Dealmaking is exciting and fun, and
  working is grubby."_ John Medlin: serial acquirers are _"running
  a chain letter in reverse."_ Compensation alignment: partner in
  both directions, not just upside; stock options as _"heads I win,
  tails you lose."_ Capital charge on subsidiary managers creates
...
- **1995** — GEICO acquisition complete at $2.3 billion for the remaining
  ...
  in 1995."_ Retailing passage: the have-to-be-smart-every-day vs
  have-to-be-smart-once heuristic — _"in retailing, to coast is to fail."_
  Contrast with the network TV station where _"you could put in a shiftless
  and backward nephew to run things."_ Acquisition discipline reinforced:
...
- **1996** — introduces [[Circle of Competence]] as a named concept:
  _"You don't have to be an expert on every company, or even many. You
  ...
  boundaries, however, is vital."_ The two-course curriculum: _"investment
  students need only two well-taught courses — How to Value a Business,
  and How to Think About Market Prices."_ The ten-year test. "The
...
- **1997** — first comprehensive treatment of [[Insurance Float]]: the
  ...
  stock-only merger record has left shareholders worse off; _"when I've issued
  stock, I've cost you money"_; Berkshire's roster of .380 hitters makes it
  _"almost impossible to trade up."_ Net-buyer logic: _"Disinvestors lose as
  market falls — but investors gain."_ Hamburger analogy. Ted Williams fat-
...
- **1998** — most sustained accounting critique in the corpus. Option
  ...
  compensation, what are they? If compensation isn't an expense, what is it?"_
...
- **1999** — the most important valuation framework letter in the corpus.
  ...
  an asset will _produce_; speculation is what the next person will _pay_
  — the distinction is structural, not stylistic. Growth is a component
  of the value calculation, not a separate style: _"the phrase 'value
  investing' is redundant."_ Internet bubble critique: _"at what point
  did the 'business' of gathering losses become a positive enterprise?"_
  ...
  Circle-of-competence exclusion of technology: _"our problem — which we
...
- **2000** — eight acquisitions completed; the largest single-year
  ...
  corporate steward who will preserve them; _"how much better it is for
  the 'painter' of a business Rembrandt to personally select its permanent
  home."_ Seller-preference dynamic as sourcing advantage: Berkshire sees
  ...
  → growth gap → accounting acrobatics → fraud snowball; _"it's far
  easier to simply tell the truth"_; CEOs who frame dishonesty as minor
  misdemeanour are confusing _pen_ with _gun_. Selective disclosure
...
- **2001** — the September 11th letter. Three underwriting principles
  ...
  Noah Rule introduced: _"Predicting rain doesn't count; building arks
  does."_ Buffett knew Berkshire was holding uncapped terrorism risk at
  ...
  the _well-mannered room_ where independent directors are not. Three
...
- **2002** — accounting and governance consolidation letter. Derivatives
  ...
  only public company to voluntarily report pro-forma _lower_ than audited.
  First explicit canonical statement of lumpy-15%-vs-smooth-12%: _"we
  prefer a lumpy 15% return to a smooth 12%."_ Updates: [[Earnings Integrity]]
...
- **2008** — the financial crisis letter. _"Pessimism is your friend, euphoria
  ...
  funds very private."_ Black-Scholes critique: historical volatility
...
- **2009** — _"What we don't do"_ four operating constraints by inversion:
...
- **2010** — _"Life and Debt"_ section: the zero-multiplier argument (_"any
  ...
  with which retained earnings will be deployed_; Sears/Montgomery Ward vs
  ...
  evaluation; adequate premium; willingness to walk away — _"testosterone-
  driven CEO"_ as the fourth-commandment failure mode. Biennial manager memo:
  _"We can afford to lose money — even a lot of money. But we can't afford
  to lose reputation — even a shred of reputation"_; newspaper test (_"unfriendly
...
- **2011** — the investment-categories essay is the standout analytical
  ...
  _"bonds promoted as offering risk-free returns are now priced to deliver
  return-free risk"_; the invisible inflation tax across 1965–2011 was more
...
- **2013** — the investment essay contains Buffett's most tangible statement
  ...
  approximately 10% unleveraged yield (_"I needed no unusual knowledge or
  intelligence to conclude that the investment had no risk"_), and a New York
  retail property bought from the RTC in 1993 at similar terms. Neither
  required a macro view. The lesson: _"Forming macro opinions or listening to
  ...
  important."_ The Mr. Market framework is extended via a moody-neighbour farm
  analogy: a neighbour who shouts daily prices should be ignored unless his
  price is wildly attractive; _"a climate of fear is your friend when investing;
  a euphoric world is your enemy."_ The sharpest single-sentence version of the
  investment/speculation distinction in the corpus: _"If you instead focus on
  the prospective price change of a contemplated purchase, you are speculating."_
...
- **2014** — the fiftieth-anniversary letter. Buffett writes an analytical
  ...
  (the daily neglect of the moat that accumulates invisibly; _"widening the
  moat"_ is the explicit counter-discipline). Buffett argues only a vigilant
  CEO can prevent the ABCs from taking hold, and that character matters more
  than analytical ability: _"Charlie and I look for companies that have all
  ...
  company, not for personal enrichment."_ The three pillars of financial staying
...
- **2015** — float reaches $87.7B; thirteenth consecutive year of underwriting
  ...
  is definitively a real expense: _"If compensation isn't an expense, what
  is it?"_ BNSF depreciation flagged as understating true maintenance capex
...
- **2017** — float reaches $114.5B following the AIG deal (world-record
  ...
  to them."_ Spreadsheets never disappoint — the barber analogy restated.
  The Bet final results published: S\&P 125.8% total return over ten years
  (8.5% annual) against fund-of-funds ranging from 2.8% to 87.7%; _"fees
...
- **2019** — GAAP earnings $81.4B vs operating earnings $24B; the mark-
  ...
  of Retained Earnings"_ essay: Edgar Lawrence Smith's 1924 discovery
...
- **2022** — Berkshire's 58-year record: 19.8% compound annual gain vs
  ...
  and adaptability. _"Bold imaginative accounting... has become one of
  the shames of capitalism."_ _"At Berkshire, there will be no finish
...
- **2023** — Charlie Munger tribute: _"Charlie Munger — The Architect of
  Berkshire Hathaway."_ Munger died 28 November 2023, 33 days before his
  ...
  reads widely, ignores pundits, no new trades for 43 years; _"patience
...
- **2024** — operating earnings $47.4B (record; up from $37.4B); 53% of
  ...
  39,054%. Mistakes and candour: Tom Murphy's principle — _"praise by name,
