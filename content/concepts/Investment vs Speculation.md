...
The 2000 letter contains Buffett's clearest and most compressed statement of
what makes something an investment rather than a speculation, and of the
universal formula for valuing any asset purchased for financial gain. The
framework is ancient — he traces it to Aesop — and deliberately simple: it
admits no exceptions based on asset class, market era, or technology cycle.

Aesop's observation that "a bird in the hand is worth two in the bush" is,
Buffett argues, the complete valuation formula, once it is extended by three
questions:

> How certain are you that there are indeed birds in the bush? When will they
...
Speculators as a group earn exactly the returns of the productive assets
minus their transaction costs; the only question is who beats whom. Investors
as a group earn the returns of the underlying assets, whatever those are.

## Growth is a component, not a style

The 2000 letter contains one of Buffett's most direct attacks on the
...
See [[Growth vs Value False Dichotomy]] for the parallel arguments from
Sleep and Fisher.
...
independently, and the patience to wait for those occasions without
manufacturing action in between.

When the range is too wide — when uncertainty about the birds is fundamental
rather than reducible — the correct answer is: this is a speculation, not an
investment. Any capital commitment under those conditions is labelled
speculative regardless of how it is reported or packaged.

## The Cinderella market

The 2000 letter offers the most memorable description of what happens to
...
> that have gigantic valuations relative to the cash they are likely to
...
sell before the turn. No signal is visible until the turn has already
happened. The result is that the terminal loss falls on whoever is left
holding, not on whoever was least astute. This randomness of outcome is a
feature of speculation, not of investment.

## Birdless bushes: the dotcom critique
...
destroyed in aggregate. The dotcom businesses that lost money over their
lifetimes, however high their interim valuations reached, destroyed value.
...
The framework does not say that uncertainty makes something a speculation.
All investments involve uncertainty about the future emergence of birds.
The distinction is whether the buyer's return depends on business performance
or on the next buyer's willingness to pay more. A business whose cash flows
are genuinely uncertain but that is being purchased on an assessment of those
cash flows is an investment, imprecise but legitimate. A business being
purchased solely because prices have been rising — "the momentum trade" — is
a speculation regardless of how well or poorly the underlying business
performs.

The framework also does not say that commonly used metrics (P/E, yield,
book value, growth rates) are irrelevant. They are relevant insofar as they
are informative about the three Aesop questions. A low P/E may be evidence
that the price offered for the bird in hand is low relative to the birds
...
which holds that market prices already reflect all available information and
that the investment/speculation distinction therefore collapses — every
...
- [[Margin of Safety]] — what to do when the estimation range is wide
- [[Growth vs Value False Dichotomy]] — parallel arguments from Sleep and Fisher
- [[Circle of Competence]] — precondition for answering Aesop's first question
- [[Destination Analysis]] — Sleep's structural analogue; what the bush
  will look like when all birds have emerged
- [[Mr. Market]] — the market mechanism that periodically offers bird-in-hand
