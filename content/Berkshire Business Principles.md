...
and the ABCs of business decay); 2020 letter ("Two Strings to Our Bow"
and the conglomerate critique); 2023 letter, BHE regulatory risk and
BNSF candour; 2024 letter, mistake culture, school-blindness, and
Greg Abel succession.

## Summary

In the 1983 letter Buffett does something he had not done before and
would not need to do again: he writes the operating philosophy of
Berkshire Hathaway down as a numbered list of principles and addresses
it to his shareholders as a manual. The opening sentence sets the
posture:
...
> ourselves as managing partners.

The list itself runs to thirteen items in the original. Subsequent
letters reproduce and refine it, but the 1983 letter is where the
manual is laid out for the first time and where the language is
freshest. The principles cover, in their broadest groupings:
ownership posture, capital allocation, accounting honesty, debt
discipline, communication policy, and incentive design. Reading the
manual is the closest thing the corpus offers to a single-page
summary of how Berkshire is run and what shareholders can expect from
the people running it.

## Why it matters

The manual is the document a long-term Berkshire shareholder is
implicitly signing onto. Most public-company shareholders do not
have anything analogous: the prospectus is regulatory boilerplate,
the proxy is a vote on a slate of names, and the annual letter is
typically a marketing artefact. The Owner's Manual is a contract of
expectations, written without legal force but with reputational
force, and held to over the subsequent four decades.

Its value to the wiki is structural. Many of the wiki's other pages —
[[Look-Through Earnings]], [[Concentration]], [[Acquisition Discipline]],
[[Issuance and Buyback Discipline]], [[Intrinsic Value vs Book Value]]
— are operational consequences of one or more of the principles in
this manual. The manual is the page they all pivot off.

## The thirteen principles in plain summary

Buffett numbers them; the wording varies slightly across reissues but
the substance is stable. Compressed:

1. Although our form is corporate, our attitude is partnership.
2. We eat our own cooking — most of our personal net worth is in
   Berkshire stock, and we run the company accordingly.
3. Our long-term economic goal is to maximise the average annual
   gain in per-share intrinsic business value, not in size, sales,
   or any other accounting magnitude.
4. Our preference is to reach this goal by directly owning a
   diversified group of businesses with consistent earning power
   and superior returns on capital.
5. Where direct ownership is not available on attractive terms,
   we will own pieces of similarly excellent businesses through
...
8. A managerial wish list will not be filled at shareholder
   ...
   at control premiums that ignore long-term economic consequences
   to our shareholders.
9. We feel noble intentions should be checked periodically against
   results. We test the wisdom of retaining earnings by evaluating
   whether retention, over time, delivers shareholders at least
   one dollar of market value for every dollar retained.
10. We will issue common stock only when we receive as much in
    business value as we give. (See [[Issuance and Buyback Discipline]].)
11. We will tell you, in our reports, what we ourselves would want
    to know if our positions were reversed. We will not engage in
    accounting hocus-pocus, nor switch around our business mix to
    obscure performance.
12. Despite our policy of candour, we will discuss our activities
    in marketable securities only to the extent legally required.
    Good investment ideas are rare, valuable, and subject to being
    pried away by competitors.
13. You should be fully aware of one attitude Charlie and I share
    that hurts our financial performance: regardless of price, we
    have no interest at all in selling any good businesses that
    Berkshire owns. Gin-rummy managerial behaviour is not our
    style.

The wording above is paraphrased rather than quoted verbatim; the
1983 letter and most subsequent letters carry the principles in
nearly-identical language, and the careful reader is invited to
compare the original.

## What the manual is doing
...
their own sake, retain only when retention earns its keep, and issue
shares only at fair value. Each constraint cuts off a class of
behaviour that public-company managers routinely engage in. The
constraints together produce a posture toward capital that is
recognisable across the corpus and is the operating foundation of
...
earnings are equivalent to giving them a free option on a
compounding savings account, and that Berkshire's preferred
incentive structure ties bonuses to results within each manager's
specific area of responsibility rather than to the price of
Berkshire stock. The principle is therefore not just a personal
gesture; it is the foundation of an incentive system that tries to
...
this with the stock-splits-and-stock-activity discussion that
argues against splits because splits attract a different class of
holder. Buffett wants long-term, owner-oriented shareholders, and
he is using the manual to advertise for them.

## What the manual isn't

It isn't a strategic plan. The principles describe how decisions
...
It isn't a moral statement. The principles are partly aesthetic and
...
It isn't, finally, a complete operating manual. The principles tell
shareholders how Berkshire will think about decisions; they do not
tell anyone how to make those decisions in the first place. The
operational substance — how to evaluate a business, how to size a
position, when to sell, how to underwrite insurance — appears
across the rest of the corpus. The manual is the constitution; the
operating decisions live in the rest of the letters.
...
The 2005 letter specifies three and only three contexts in which Berkshire
borrows:

First, short-term repos against US government or agency securities used in
opportunistic investing. These involve only the most liquid securities;
the positions are inherently temporary and have since been unwound or run off.

Second, debt against portfolios of interest-bearing receivables whose risk
characteristics are thoroughly understood. The example given is Clayton Homes'
...
consolidated balance sheet but is MidAmerican's obligation alone; Berkshire
does not guarantee it. The 2005 letter argues it is nonetheless secure because
MidAmerican operates a diversified portfolio of regulated utility properties
whose earnings are highly stable and sufficient to cover debt service even if
one property underperforms.

The common thread across all three categories is that the debt is either
genuinely short-term, backed by specific assets whose risk characteristics
are well understood, or secured against highly predictable regulated cash flows
that are structurally independent of the broader Berkshire enterprise. Debt
that is none of these — borrowed to fund general corporate activities, to
finance acquisitions at prices whose outcome is uncertain, or to smooth
earnings across reporting periods — is absent from the list.

## Widening the moat: the daily management discipline (2005)

The 2005 letter adds a formulation about the operating-level consequence of
the long-term orientation that runs through the Owner's Manual. Principle 3
commits Berkshire to maximising per-share intrinsic value; the 2005 letter
...
industries as live examples of organisations whose current managers are
struggling with the accumulated consequences of their predecessors' short-term
compromises.

The moat-widening framing is a bridge between the Owner's Manual principles
and the operational decisions of individual subsidiary managers. The thirteen
principles describe what Berkshire will do as a holding company; the moat-
widening discipline describes what each subsidiary manager should be doing as
an operator.

## Management succession (2005–2006)

The 2005 and 2006 letters address the question of succession more directly than
any prior letters, reflecting Buffett's and Munger's advancing ages and the
scale that Berkshire had reached.

The 2005 letter states that three internal CEO candidates had been identified
and that the board had unanimously agreed on succession. Names are not
disclosed; the identification has been made so that in the event of Buffett's
incapacitation a successor is already chosen rather than requiring the board
to begin a search under pressure.

CIO succession proves harder to resolve. Lou Simpson, GEICO's investment
manager, is the only person in Berkshire whose investment record approaches
Buffett's in both quality and duration. But Simpson was then 69, making him
too close to Buffett's own age to serve as a meaningful successor for the
investment function. The 2005 letter acknowledges honestly that the question
of who will eventually manage Berkshire's investment portfolio is unsolved.
...
rather than a complete resolution; the full succession architecture
remains in progress as of the 2010 letter. (The CEO succession question
is resolved by 2024 — see "Greg Abel: succession made explicit" below.)

## What we don't do: operating constraints by inversion (2009)

The 2009 letter contains an unusual section framed entirely by negation. Rather than describing what Berkshire does, it catalogues four things Berkshire does not do. The inversion is deliberate — it answers the implicit question of what, exactly, distinguishes a permanently-run operating company from a financial conglomerate or a private equity portfolio. The four constraints:

First, Berkshire will not invest in businesses whose futures cannot be evaluated with reasonable confidence. This is the [[Circle of Competence]] principle stated as an absolute. There is no qualifying exception for "high-conviction speculation" or "asymmetric upside." If the future cannot be evaluated, Berkshire passes. The effect is that the universe of businesses Berkshire owns is substantially smaller than the universe of businesses available — and this is the point, not a limitation to work around.
...
Taken together, the four negatives define a posture that is unusual enough to constitute a genuine competitive advantage. Berkshire can acquire businesses and give their managers certainty that the operating model will not change, that leverage will not be imposed, that meddling will not occur. This is worth something to sellers who care about what happens to their employees and culture after the sale.

## The third component of intrinsic value: efficacy of retained earnings (2010)
...
passive owner with no say in management. The expected result is identical
in principle: own pieces of businesses with long-lasting favourable
economic characteristics and trustworthy managers. The mechanism is
different (influence through capital allocation vs. appreciation in market
price), but the analytical framework is the same.

The 2020 letter places this architecture in deliberate contrast with the
classic conglomerate model of the 1960s and 1970s. Classic conglomerates
used two techniques that Berkshire explicitly avoided: promotional
...
## Honest about structural risks: BHE and BNSF (2023)
...
## Mistake culture and the cardinal sin (2024)

The 2024 letter opens with a meditation on error that amounts to a policy statement about how Berkshire treats mistakes, stated more explicitly than anywhere else in the corpus.
...
Buffett's formulation is careful: he is not arguing that formal education is valueless, but that it is not a reliable proxy for the traits that matter in Berkshire's CEO selection — the combination of rational temperament, deep business understanding, love of the work, and the character to sustain effort over decades. The 2014 letter established those as the primary criteria; the 2024 letter adds what is not on the list.
...
None internal to Buffett. Across sources, the principles do not
contradict Sleep's [[Nomad Partnership Letters]]
posture — Sleep's letters explicitly mirror the partnership
language and several of the principles. They are in tension with
parts of [[Invent and Wander]] in places: Bezos's willingness to
