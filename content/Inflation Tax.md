...
Buffett's recurring argument that high inflation, combined with the
explicit tax on nominal investment returns, can convert ostensibly
strong corporate performance into negative real returns for
individual owners. The argument runs across four early letters
...
The argument is corrosive to several comforting investor habits. It
undermines the claim that long-run equity returns are reliably
positive in real terms; the 1981 letter argues directly that this is
no longer true on average. It undermines the use of historical p/e
ratios as benchmarks, because the passive returns those ratios were
calibrated against have shifted. And it undermines the logic of
retention by weak businesses: the 1981 letter argues that retention
by low-return businesses is forced by the inflation tapeworm rather
than chosen for the owners' benefit, but the owners pay the cost.

The argument also reframes what an investor is actually looking for.
The hurdle is not "earn a positive number" but "earn enough above the
passive after-tax bond rate to justify the additional risk." When
that gap closes — as it had by 1981, with long-term tax-exempts
yielding 14% and average corporate ROE around 14% — equity ownership
loses its structural advantage. The investor who does not adjust
ends up paying for risk they are not being compensated for.
...
The structural-economics implication links directly to
[[Tailwinds vs Headwinds]]. The 1981 letter's first category of
admirable acquirers is companies that have specialised in
inflation-resistant businesses — those with pricing power and low
incremental capital intensity. These are the businesses for which
inflation is least destructive, because the structural economics let
them pass costs through without consuming all the proceeds in
reinvestment. Industry-choice primacy and inflation-resistance are
the same lesson seen from two angles.

## How retention behaves under inflation

The 1981 letter's Matthew 25 reference makes the point concrete. In a
non-inflationary world, high-return businesses should retain (since
...
of what its tangible-capital base would produce at ordinary
returns. Businesses with substantial Economic Goodwill have most
...
must be redeployed to keep receivables, inventory, and physical
plant at their pre-inflation real volume. A business whose value
is largely tangible bleeds dollars to the tapeworm year after
...
that the owner of a comparable-earnings textile or steel business
was not.
...
businesses Buffett wants are precisely those whose structural
economics neutralise the inflation tax.

The implication for the investor's misery index is that the index
is not uniform across businesses. The owner of an Economic-
Goodwill-heavy business at criterion-4 prices passes the
real-return test even at inflation rates that would defeat the
average corporate owner. The owner of a Goodwill-light business
at any price probably does not. See [[Economic Goodwill]] for the
fuller treatment of how the mechanism is recognised, and
[[Tailwinds vs Headwinds]] for the operational signature.
...
returns, not predictive about what inflation will do.

It is also not an argument for fleeing equities. Buffett continues to
invest heavily through 1979–1981. The argument is that an investor
must be honest about whether the equity premium is real in the
current environment, and that some investments which look attractive
on nominal numbers fail the real-return test. The discipline is to
do the after-inflation, after-tax arithmetic before concluding that
nominal returns mean genuine wealth has been created.

## The Munger frame

The argument lines up with the Munger ethos this wiki tries to
honour. The investor who reasons in nominal dollars is committing a
...
qualified-yes; the qualifications matter.
