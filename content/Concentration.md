...
Buffett's policy of holding a small number of large positions rather
than a diversified portfolio. The 1978 letter is the first place in the
modern letters series where the policy is stated explicitly:

> Our policy is to concentrate holdings. We try to avoid buying a
> little of this or that when we are only lukewarm about the business
> or its price. When we are convinced as to attractiveness, we believe
> in buying worthwhile amounts.

The same letter gives the worked example: a SAFECO Corporation purchase
...
Concentration is the operational consequence of [[Buffett's Four Criteria]] taking the price test seriously. If genuine criterion-4
opportunities are rare, an investor who has found one and only buys a
small position is not really acting on the conviction the framework
requires. The framework's filter is strict; concentration is what
makes the strictness pay.

The deeper claim is that diversification is a tool for ignorance.
Buffett's framing across the early letters is that the investor who
cannot tell which of several candidates is best should hold all of
them in roughly equal weights — but the investor who can tell should
not. Diversification is then a confession of analytical inability, not
a virtue. Where the inability is real (most investors most of the
time), diversification is the right answer; where it is not,
concentration captures returns that diversification dilutes.
...
It is not a claim that all investors should run concentrated
portfolios. The 1978 letter's framing is operator-specific — Berkshire
has the analytical capacity, the temperament, and the information flow
to support concentration. Investors lacking any of the three are
unlikely to do better with the policy than with a diversified default.
The wiki should resist generalising from Buffett-the-operator to
investors-in-general; the policy is part of an integrated approach,
not a portable rule.

It is also not a claim that concentration is permanent. The 1978
letter is explicit that positions are sized to conviction at a moment
in time; if conviction declines (criteria 1–3 deteriorate, or
criterion 4 inverts), the position should shrink. Concentration is a
sizing discipline, not a hold-forever discipline. The hold-forever
question is treated separately — and differently — in later letters.

## The know-something / know-nothing distinction (1993)

The 1993 letter gives the most explicit statement Buffett ever made of
when concentration is and is not the right policy. The distinction
...
has implicitly concluded that position 20 is worth owning alongside
positions 1 through 5. If position 20 has lower conviction and lower
understanding than position 1, adding to position 1 is both less risky
(better understanding, lower estimation error) and higher return
(higher conviction means higher expected value). Conventional
...
not one huge one. Concentration is right for high-conviction, well-
understood businesses; diversification is right for genuinely opaque
situations where the edge comes from having many independent exposures.
See [[Investment Risk vs Beta]].

## How concentration interacts with non-control ownership

The 1980 and 1981 letters extend the framing in a way the 1978 letter
...
concentration plus full ownership, because the exit is cheap. The
investor who concentrates but cannot easily exit — for example, a
private equity owner — is running a different and harder game.

## The financial-strength prerequisite (1984 reinforcement)
...
comparable degree of concentration (or anything close to it) would
...
forty rather than deep knowledge of a few. And it's arguing that
the cost of diversification is hidden: it does not show up in the
returns of the diversified portfolio in calm markets but does show
up in the inability to act with conviction when an opportunity
appears.

The 1984 letter also extends concentration explicitly to bond
...
purchases of underlying businesses, sized to conviction within the
...
is structurally hostile to professionals whose careers are at risk
on every quarterly comparison to a benchmark.

## The diagnostic question

The test for whether a position is appropriately sized is not "would I
be comfortable if it doubled in importance" but "would I be comfortable
if my analysis turned out to be wrong by, say, half." Concentration
without genuine conviction is just leverage. Conviction without
concentration is just commentary. The two have to be paired.

## Where this connects to Sleep

Sleep arrives at a similar policy through a different route. The Nomad
Partnership Letters describe a portfolio of seven to ten positions,
chosen with the same kind of structural-economics filter Buffett
applies, and held with comparable patience. Sleep does not articulate
the concentration policy as crisply as Buffett does in 1978, but the
operational outcome is similar: a small number of large positions in
businesses Sleep has analysed deeply.

Sleep's filter is the [[Scale Economics Shared]] model: he looks for
businesses that reinvest their cost advantages into lower prices for
customers rather than extracting them as margin. This screen is
narrower than Buffett's [[Buffett's Four Criteria]] and points Sleep
toward a smaller universe of candidates. In the Nomad Partnership's
later years (2010–2013), the portfolio had effectively converged on
five to seven positions — Costco, Amazon, AirAsia, Berkshire Hathaway,
ASOS, and a handful of others — in which Sleep had extremely high
conviction and which he described as near-permanent holdings.

The philosophical basis for concentration is also different between
the two. Buffett argues explicitly that concentration is the correct
policy for anyone with genuine analytical advantage, and that
diversification is the correct policy for anyone without it. Sleep's
argument runs more through [[Reinvestment Risk]]: concentration is
justified because the cost of being wrong about a highly analysed
position is lower than the cost of spreading capital across positions
that have been analysed less deeply, any of which might be exited
at the wrong moment. Concentration, for Sleep, is also a commitment
device — it is harder to abandon a thesis when the position is large.

The [[Concentration vs Diversification]] contradiction page examines
where Buffett and Sleep agree against most of the academic finance
tradition, and where their reasoning parts company.
...
is not a portfolio, and treating it as one by keeping options open and
spreading effort across many avenues is the indefinite-optimist failure mode.
This is not an investing argument in the strict sense but it reinforces the
logic underlying Buffett's harem formulation — depth of understanding per
position beats shallow knowledge of many positions, whether the positions are
stocks, business relationships, or endeavours.
...
- [[Investment Risk vs Beta]] — the know-something/know-nothing
  distinction; concentration reduces real risk for the right investor
  by increasing analytical depth per position
- [[Zero to One]] — source page; the power law argument as a VC-portfolio
  version of the concentration principle
- [[Definite vs Indefinite Optimism]] — indefinite optimism as the
  failure mode that produces over-diversification across positions and options
