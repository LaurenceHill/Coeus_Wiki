...
- [[Common Stocks and Uncommon Profits]] — Philip A. Fisher, 1958
  (ingestion complete; _Common Stocks and Uncommon Profits_, _Conservative
  Investors Sleep Well_, and _Developing an Investment Philosophy_ all read)
- [[Paths to Wealth Through Common Stocks]] — Philip A. Fisher, 1960
  (ingestion complete)
- [[Nomad Partnership Letters]] — Nick Sleep & Qais Zakaria, 2001–2014
  (ingestion complete; all 25 letters plus 2021 postamble read)
...
- [[Fifteen Points]] — Fisher's checklist for what to buy
- [[Scuttlebutt]] — Fisher's primary research method
- [[Financial Community Appraisal]] — Fisher's theory that price is driven
...
- [[Issuance and Buyback Discipline]] — transact in own shares only when intrinsic value and price are favourably aligned (1982 issuance; 1984 buybacks; 1985 stock-options critique)
- [[Owner Earnings]] — Buffett's preferred cash-flow measure; rejects the "cash flow fallacy" of adding back depreciation without subtracting maintenance capex (1986 Appendix)
- [[Mr. Market]] — Graham's parable of the manic-depressive business partner; price serves you, it does not guide you (1987; extended 1990)
- [[Institutional Imperative]] — four manifestations of the organisational force that causes rational managers to make irrational decisions (1989)
- [[Franchise vs Business Economics]] — Buffett's 1991 formal definition: three-part franchise test, mismanagement-tolerance asymmetry, 25x vs 10x valuation math
- [[Creative Monopoly]] — Thiel's central thesis: competition destroys profits; monopoly is the condition of every successful business; four characteristics; start small and monopolize; last mover advantage; seven questions
- [[Definite vs Indefinite Optimism]] — Thiel's 2×2 framework: definite/indefinite × optimist/pessimist; indefinite optimism as the dominant dysfunctional US worldview; design over chance
- [[Margin of Safety]] — Graham's three words; Buffett's cornerstone of investment success; the purchase discipline that corrects for estimation error
- [[Investment Risk vs Beta]] — Buffett's five-factor real-risk framework; volatility is not risk; know-something vs know-nothing investor (1993)
- [[Circle of Competence]] — Buffett's discipline: know the boundaries of what you understand; size of circle is less important than knowing where it ends (1996)
- [[Insurance Float]] — the mechanics and economics of insurance float; cost of float as the primary metric; Berkshire's structural advantage from permanent capital (1997–2006)
- [[Earnings Integrity]] — option expensing as accounting fiction; Son of Gresham; restructuring charges; auditor capture; derivatives as WMD; Fred Futile dividend-withholding illustration; what Berkshire does instead (1997–2005)
...
- [[When to Sell]] — Fisher's three reasons (and only three)
- [[Patience as Competitive Advantage]] — Sleep's edge from low turnover
- [[Reinvestment Risk]] — the cost of being forced to redeploy capital
- [[Long-Term Thinking]] — Bezos's framing, Sleep's framing, Fisher's framing
- [[Look-Through Earnings]] — Buffett's lens for valuing fractional ownership (1980)
...
- [[Two-Way Doors]] — Bezos's reversible-vs-irreversible decision frame
- [[Disagree and Commit]] — Bezos's mechanism for high-velocity decisions

### Operating philosophy

- [[Customer Obsession]] — Bezos's first principle
- [[Flywheel]] — Bezos's reinforcing-loop business model
- [[Day 1]] — Bezos's anti-stagnation discipline
- [[Wandering]] — Bezos's case for guided non-linear exploration
- [[Six-Page Narratives]] — Amazon's no-PowerPoint memo discipline
- [[Free Cash Flow Over Earnings]] — Bezos's headline metric choice
- [[Alert Corporate Management]] — Fisher's moat analysis via capital
  intensity: high earnings on low assets warns of shallow competitive barriers
- [[Dividends]] — Fisher's contrarian dividend philosophy
- [[Berkshire Business Principles]] — Buffett's 1983 Owner's Manual: thirteen principles for the company-shareholder relationship

### Character and orientation

- [[Missionaries vs Mercenaries]] — Bezos's primary leader-evaluation heuristic
- [[Gifts vs Choices]] — Bezos's Princeton commencement framing

### Macro context

- [[Stocks and Inflation]] — Fisher's argument that only growing-earnings
...
These get their own pages because the disagreement matters more than either
side's solo argument.

- [[Selling vs Holding Forever]] — Fisher's 3 reasons vs Sleep's "near permanent"
- [[Bet on Big Ideas vs Don't Buy Promotional Companies]] — Bezos vs Fisher
- [[Anderson on Bezos vs Bezos on Bezos]] — source-reliability note, now
  strengthened by access to the primary text
- [[Concentration vs Diversification]] — different paths, same destination
- [[Growth vs Value False Dichotomy]] — Sleep, Buffett, Fisher all agree it's false

## How to read this wiki

Munger's instruction is to invert. Each page tries to surface not just what
the source claims, but what failure mode the claim is built to prevent.
Where the five sources genuinely disagree, that disagreement is preserved
rather than smoothed over.

Where the wiki has both a primary-source page (e.g. [[Big Winners Pay for Many Experiments]] from Bezos's own 2015 letter) and a secondary-source
page on the same idea (e.g. [[Successful Failure]] from Anderson's
commentary), the primary-source page is authoritative. The secondary
page is preserved as a record of how the idea has been transmitted.

## Reading order suggestions

- **First-time investor:** start with [[Fifteen Points]],
...
- **Studying time horizon:** [[Destination Analysis]],
  ...
  [[Reinvestment Risk]], [[Selling vs Holding Forever]].
- **Studying decision-making:** [[Regret Minimization Framework]],
  [[Two-Way Doors]], [[Disagree and Commit]],
  [[Big Winners Pay for Many Experiments]], [[Wandering]],
  [[Working Backward]].
